...
<head>
    ...
    <meta name="keywords" content="5Y Coffee, 5Y , Cafe, quan ca phe, ca phe, cafe, coffee house, ca phe phin, Viet">
    <meta name="description" content="5Y Coffee - Thương Hiệu Cà Phê Đà Thành">
	...
	<link rel = "icon" href = 
"<c:url value='/template/web/images/logoMoiCoTen.png' />" 
        type = "image/x-icon">
